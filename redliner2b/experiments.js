...
///////////////
/*Attempted to make it change position based on sin*/
//////////////
...
for (i=1;i<10;i++) {
  //local sin wave calculations
  //center it, sin wave position relative to i, -offset
  push();
  // let xpos = i*100 - windowWidth/2 + 100;
  let xpos = sin(PI/2/i) + 100;

  let ypos = windowHeight/2 * sin(PI/2/i);
  noStroke();
